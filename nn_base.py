...
# Derived from http://arctrix.com/nas/python/bpnn.py, MIT license.
...
class DNN(Serializable):
    ...
    def forward(self, bi):
        ...
        bii = np.matrix(bi)
        #print bii
        self.input_shape = tuple(self.input_shape)# if type(self.input_shape)=="<type 'list'>" else self.input_shape
